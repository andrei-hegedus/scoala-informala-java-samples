...
public class MetricWeightConverter {
	...
	private static final Convertion [] CONVERTIONS = new Convertion[]{
		new Convertion(Weight.KILO_GRAMS, Weight.GRAMS, 1000d),
	...
	public Weight convert(Weight weight, String toFormat){
		...
		if(convertion==null){
			throw new IllegalArgumentException("No rate found for "+weight.getFormatName()+" - "+toFormat);
		}
